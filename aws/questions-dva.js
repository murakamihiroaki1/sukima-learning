const questionsData = [
    ...
    },
    {
        ...
        options: [
            ...
            'Amazon API GatewayでGraphQLエンドポイントを作成する。Amazon DynamoDBテーブルをデータストアとして使用する。',
        ...
        optionExplanations: [
            ...
            '誤り：API GatewayはネイティブにGraphQLをサポートしていません。GraphQLにはAWS AppSyncを使用する必要があります。',
    ...
    },
    {
        ...
        options: [
            'Amazon Cognitoを使用して、サインアップおよびサインイン機能を提供する。',
        ...
        optionExplanations: [
            '正解：Amazon Cognitoは、ウェブおよびモバイルアプリケーション向けの完全なユーザー認証・認可ソリューションを提供します。',
    ...
    },
    {
        ...
        optionExplanations: [
            ...
            '正解：リソースポリシーを使用して、特定のAWSアカウントのIAMユーザーにAPIアクセスを許可できます。',
    ...
    },
    {
        ...
        optionExplanations: [
            ...
            '誤り：タイムアウト設定を増やしても、メモリ不足の問題は解決されません。処理時間が長くなるだけです。',
    ...
    },
    {
        ...
        options: [
            ...
            'Lambda関数にPowerUserAccessマネージドポリシーをアタッチする。',
        ...
        optionExplanations: [
            ...
            '誤り：PowerUserAccessは、多くのAWSサービスへのアクセスを許可するため、最小権限の原則に反します。',
    ...
    },
    {
        ...
        question: 'ある会社がAWSアカウントのREST APIにAmazon API Gatewayを使用しています。デベロッパーは、別のAWSアカウントのIAMユーザーのみにAPIへのアクセスを許可したいと考えています。\n\nこれらの要件を満たすために、デベロッパーが取るべきステップの組み合わせはどれですか (2つ選択)。',
        options: [
            'IAMアクセス許可ポリシーを作成する。ポリシーを各IAMユーザーにアタッチする。APIのメソッド認可タイプをAWS_IAMに設定する。署名バージョン4を使用してAPIリクエストに署名する。',
            'Amazon Cognitoのユーザープールを作成する。各IAMユーザーをユーザープールに追加する。APIのメソッド認可タイプをCOGNITO_USER_POOLSに設定する。Amazon CognitoでIAM認証情報を使用して認証する。IDトークンをリクエストヘッダーに追加する。',
            'Amazon Cognitoアイデンティティプールを作成する。各IAMユーザーをアイデンティティプールに追加する。APIのメソッド認可タイプをCOGNITO_USER_POOLSに設定する。Amazon CognitoでIAM認証情報を使用して認証する。アクセストークンをリクエストヘッダーに追加する。',
            '各IAMユーザーのみにアクセスを許可するAPIのリソースポリシーを作成する。',
            'API用のAmazon Cognitoオーソライザーを作成して、各IAMユーザーのみにアクセスを許可する。APIのメソッド認可タイプをCOGNITO_USER_POOLSに設定する。'
        ...
        optionExplanations: [
            '正解：IAMポリシーとAWS_IAM認可タイプを使用し、Sigv4で署名することで、クロスアカウントアクセスを実現できます。',
